      ...
      >
        ...
        <ThemeContextProvider>
          <ActiveSectionContextProvider>
            ...
            <div className=" bg-[#fbe2e3]/70 absolute bottom-[-1rem] -z-10 left-[-35rem] h-[21.25rem] w-[30rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#946263]/70" />
            <div className="bg-[#dbd7fb]/70 absolute bottom-[-6rem] -z-10 right-[11rem] h-[21.25rem] w-[21.25rem] rounded-full blur-[10rem] sm:w-[48.75rem] dark:bg-[#676394]/70" />
